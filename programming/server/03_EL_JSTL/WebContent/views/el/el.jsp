...
<%--
	/*
	//request 객체에 저장된 속성을 가져온다.
	String classRoom = (String)request.getAttribute("classRoom");
	Person student = (Person)request.getAttribute("student");
	
	//session 객체에 저장된 속성을 가져온다.
...
--%>
	...
	강사 : ${ student.name }, ${ student.age }, ${ student.gender } <br>
	...
	page 영역 : ${ scope } 또는 ${ pageScope.scope } <br>
	request 영역 : ${ requestScope.scope } <br>
	application 영역 : ${ applicationScope.scope } <br>
	session 영역 : ${ sessionScope.scope } <br>
